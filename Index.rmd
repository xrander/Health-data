...
## The Data
First I load the library for reading and analysing the data.
...
-   What is the proportion of survival and non-survival between diabetic
    and non-diabetic patients

-   What is the proportion of survival and non-survival between
    depressed and non-depressed patients

# Solution
The sql code solution to the question asked are [here](https://raw.githubusercontent.com/xrander/Health-data/master/Health_data_analysis.sql)
