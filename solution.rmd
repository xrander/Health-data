...
### Question 5c
Number of patients that died between
the gender having atrialfibrillation 
```{r}
...
To get the proportion of diabetic patient that survived, we need to know the total number of
people having diabetic and we divide that by the number of people having diabetes and survived
```{r}
...
For this we follow the same procedure as the one above but this time, the patients are not
diabetic 
```{r}
